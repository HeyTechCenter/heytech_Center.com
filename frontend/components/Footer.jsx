    ...
    <footer className="bg-[#0A0A0A] border-t border-[#1A7A4A]/20">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          {/* Description et réseaux sociaux - SANS LOGO */}
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              ...
              {/* Instagram - À ajouter quand vous aurez le lien */}
              <a
                href="#"
                className="w-8 h-8 bg-[#1A1A1A] rounded-full flex items-center justify-center text-gray-400 hover:bg-gradient-to-br hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#FCAF45] hover:text-white transition-all duration-300 opacity-50 cursor-not-allowed"
